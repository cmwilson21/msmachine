...
const Contact = () => {
  ...
  return (
    <div>
      <h3>Our 44,000 square foot facility sits just off Interstate 40 and Tennessee Avenue in Cookeville, TN. Centrally located for businesses throughout the Mid-South.</h3>
